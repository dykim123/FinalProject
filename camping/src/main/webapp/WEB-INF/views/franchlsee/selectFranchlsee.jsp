		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<form class="form-horizontal">
							<div class="panel-body">
								<div class="form-group">
									<label class="col-sm-3 control-label" for="demo-hor-inputemail">신청상태구분</label>
									<div class="col-sm-9">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="demo-hor-inputpass">승인기간</label>
									<div class="col-sm-4">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">가맹점 전체 목록</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										...
										<th class="min-tablet">신청지역</th>
										<th class="min-desktop">승인일</th>
										<th class="min-desktop">거절일</th>
										<th class="min-desktop">승인상태</th>
									</tr>
								</thead>
								<tbody>
									<tr>
